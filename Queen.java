	...
	public  ArrayList<moves> getpossiblemoves(Board a,Color g) {
		...
		while(k.getxpos()+o!=board.length&&k.getypos()+b!=board[0].length) {
			if(board[k.getypos()+b][k.getxpos()+o]==null&&(!board[k.getypos()+b][k.getxpos()+o].equals(g))) {
				moves.add(new moves(k.getxpos()+o,k.getypos()+b,"Queen"));
				o++;
				b++;
			}
		}
		...
		while(k.getxpos()-o!=board.length&&(k.getypos()!=board[0].length&&k.getypos()!=-1)) {
			if(board[k.getypos()][k.getxpos()-o]==null&&(!board[k.getypos()][k.getxpos()-o].equals(g))) {
				moves.add(new moves(k.getxpos()-o,k.getypos(),"Queen"));
				o--;
			}
		}
		while(k.getxpos()+o!=board.length&&(k.getypos()!=board[0].length&&k.getypos()!=-1)) {
		...
		while((k.getxpos()!=board.length&&k.getxpos()!=-1)&&k.getypos()-b!=-1) {
			if(board[k.getypos()-b][k.getxpos()]==null&&(!board[k.getypos()-b][k.getxpos()].equals(g))) {
				moves.add(new moves(k.getxpos(),k.getypos()-b,"Queen"));
				b--;
			}
		}

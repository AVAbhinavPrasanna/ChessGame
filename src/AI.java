...
public class AI{
	...
	public AI(String dif,Color color){
		if(dif.equals("Easy")){
			d= Diff.Easy;
		}
	...
	public void mediummove(Board a,Color j) {
		...
		for(int i=0; i<board.length;i++) {
			for(int m=0; m<board.length;m++) {
				if(board[i][m].getColor()==Color.BLACK) {
				if(move.getpiece().equals("Pawn")&&board[i][m] instanceof Pawn &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
				else if(move.getpiece().equals("Queen")&&board[i][m] instanceof Queen &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
				else if(move.getpiece().equals("Knight")&&board[i][m] instanceof Knight &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
				else if(move.getpiece().equals("Bishop")&&board[i][m] instanceof Bishop &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
				else if(move.getpiece().equals("King")&&board[i][m] instanceof King &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
				else if(move.getpiece().equals("Castle")&&board[i][m] instanceof Castle &&withinBoard(a,board[i][m],move.getx(),move.gety()) ) {
					k=board[i][m];
				}
